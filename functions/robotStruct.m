...
robot.dof = 3;
% For subs
robot.old = [d0, a1, d2, a3, h1, a2, h3, c2, b2, r1, r3, q1, q2, q3];
...
robot.link_masses = [robot.link2_mass, robot.link3_mass, robot.link4_mass];
...
robot.h3 = 0.24;
robot.r3 = 0.02;
robot.fixed_params = [robot.d0, robot.a1, robot.d2, robot.a3, robot.h1, robot.a2, robot.h3, robot.c2, robot.b2, robot.r1, robot.r3];
